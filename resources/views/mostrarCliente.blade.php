		    ...
		    <div class="row">
    			...
    			<div class="col-8">
    				<div class="info-contenido">
    					...
    					<div class="col-4">
    						<div class="row justify-content-end py-2">
        						...
        						<button class="btn btn-danger glyphicon glyphicon-trash font-weight-bold mr-2" data-toggle="modal" data-target="#EliminarCliente">
                       ...
                       <div class="col-8">
                           <div class="h-100 d-flex align-items-center">
                                <form class="form-inline search">
                                        <input class="form-control form-control-sm mr-3 w-75 search-i" type="text" name="buscarCarrera" placeholder="Lugar, nombre de chofer"
                                          aria-label="Search">
    				...
    				<div id="actividad" class="actividad mostrar-actividad">
    					<table class="table table-hover">
    						...
    						<tbody class="tabCarrera">
    							...
    							<tr>
    								...
    								<td>{{$carrerasItem->nombre_chofer}}</td>
                      ...
                      <a href="{{url()->previous()}}" class="btn btn-primary btn-volver px-3 py-1">Volver</a>
			</div>
		</div>
		@endsection
