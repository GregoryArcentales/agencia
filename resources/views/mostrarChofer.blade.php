			...
			<div class="info-contenido">
                ...
                <div class="info-contacto pb-2">
                    ...
                    <div class="row justify-content-end py-2">
                      <button class="btn btn-warning glyphicon glyphicon-pencil font-weight-bold text-white my-2 mx-2" data-toggle="modal" data-target="#EditarChofer">
                    ...
                    <div class="col-4 col-sm-8">
                     <div class="h-100 d-flex align-items-center">
                      ...
                      <div class="flex-grow-1 d-none d-lg-block">
                        <a href="{{route('generarPdfChofer', $chofer)}}" class="btn btn-primary px-3 py-1 mx-2 btn-reporte">Generar PDF</a>
                        <a href="{{route('choferExportExcel', $chofer)}}" class="btn btn-primary px-3 py-1 btn-reporte">Exportar excel</a>
                      </div>
                    </div>
                  </div>
                  </div>
				...
				<div id="actividad" class="actividad mostrar-actividad">
                    ...
                    <div class="flex-grow-1 d-flex justify-content-end d-block d-lg-none mt-2 mb-3">
                        <a href="{{route('generarPdfChofer', $chofer)}}" class="btn btn-primary px-3 py-1 mx-2 btn-reporte">Generar reporte</a>
                        <a href="{{route('choferExportExcel', $chofer)}}" class="btn btn-primary px-3 py-1 btn-reporte">Ver Todo</a>
                    </div>
